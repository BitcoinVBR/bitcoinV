...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTCV: return QString("Bitcoins");
    case mBTCV: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTCV: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
